package com.sdl.seatms.project.tool.gen.controller;

import java.io.IOException;
import java.util.List;
import javax.servlet.http.HttpServletResponse;

import com.sdl.seatms.project.tool.gen.service.IGenService;
...
public class GenController extends BaseController
{
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"sdl.zip\"");
